...
public class DriveController {
    ...
    public void onOpmodeInit(Robot2024 robot, MecanumDrive2024 drive, Telemetry telemetry){
        this.robot = robot;
        this.drive = drive;
    ...
    public double oneRotationPID(double targetAng, double currAng){
        ...
        // this is probably a modulo but i don't trust the negatives to work properly
        if(error > 180){
            error -= 360;
        } else if (error < -180){
            error += 360;
...
//        telemetry.addData("out: ", "%.2f", out);
    ...
    public void doLoop(Gamepad gamepad1, Gamepad gamepad2){
        ...
        //TODO: Uncomment if reset button required
        /*
