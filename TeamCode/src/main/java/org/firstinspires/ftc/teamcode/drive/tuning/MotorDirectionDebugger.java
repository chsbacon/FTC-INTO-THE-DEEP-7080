...
public class MotorDirectionDebugger extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            telemetry.addData("LF Encoder Ticks: ", drive.leftFront.getCurrentPosition() );
            telemetry.addData("RF Encoder Ticks: ", drive.rightFront.getCurrentPosition() );
            telemetry.addData("LB Encoder Ticks: ", drive.leftBack.getCurrentPosition() );
            telemetry.addData("RB Encoder Ticks: ", drive.rightBack.getCurrentPosition() );
            telemetry.update();
        }
    }
}
