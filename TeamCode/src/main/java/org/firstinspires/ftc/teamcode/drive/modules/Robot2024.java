...
public class Robot2024 {
    ...
    public Robot2024(LinearOpMode opMode, MecanumDrive2024 drive, boolean doDriveController, boolean doArmController, boolean doAuto){
        ...
        if (doArmController) {
            ...
            armRotationMotorR.setDirection(DcMotorSimple.Direction.REVERSE); //Change after tests
            armRotationMotorL.setDirection(DcMotorSimple.Direction.FORWARD); //Change after tests
